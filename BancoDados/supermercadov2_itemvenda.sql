...
CREATE TABLE `itemvenda` (
  ...
  KEY `venda_fk_idx` (`venda_fk`),
  KEY `produto_fk_idx` (`produto_fk`),
  CONSTRAINT `iven_produto_fk` FOREIGN KEY (`produto_fk`) REFERENCES `produto` (`idProduto`),
  CONSTRAINT `venda_fk` FOREIGN KEY (`venda_fk`) REFERENCES `venda` (`idVenda`)
