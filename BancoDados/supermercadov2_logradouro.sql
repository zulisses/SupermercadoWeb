...
CREATE TABLE `logradouro` (
  ...
  PRIMARY KEY (`idLogradouro`,`bairro_fk`),
  KEY `bairro_fk_idx` (`bairro_fk`),
  CONSTRAINT `bairro_fk` FOREIGN KEY (`bairro_fk`) REFERENCES `bairro` (`idBairro`) ON DELETE RESTRICT ON UPDATE CASCADE
