...
CREATE TABLE `itemcompra` (
  ...
  KEY `compra_fk_idx` (`compra_fk`),
  KEY `produto_fk_idx` (`produto_fk`),
  CONSTRAINT `compra_fk` FOREIGN KEY (`compra_fk`) REFERENCES `compra` (`idCompra`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `produto_fk` FOREIGN KEY (`produto_fk`) REFERENCES `produto` (`idProduto`) ON DELETE RESTRICT ON UPDATE CASCADE
